...
KI - "hva skal vi gjøre med dette her?". Forandrer samfunnet, universitetet, faget. Lenker om faget på kurssidene. [her ](https://www.mn.uio.no/math/personer/vit/snorrec/books.html)Dette blir relativt teknologifritt

__Kalkulus__: slutten av 1600-tallet. Newton, Leibniz, f. 1650, sterkt bidrag til tidlig opplysningstid.
...
Leibniz: Notasjon, integral. $\int_0^x t dt=\frac{x^2}{2}$ (mellomregning)
...
__Euler__ f. ca. 1700
Tidsskrifter fulle av analyse, formler, intergral fra minus uendelig til pluss, integral = rot pi. $e^(i*pi)+1=0$, komplekse tall, større tallsystemer. $i^2 = -1$ 
Trigonometri ligger bak. Plangeometri (neste uke). Komplekse tall (om 2 uker).^

Folk begynner vist å skrive $\sum_{m=1}^\infty \frac{1}{m^2} = \frac{\pi}{6}$
...
Oppryddnignen blir gjort av: __Cauchy, Abel__ (begynnelsen av 1800tallet) Cauchyfølger. Potensrekker (senere i semesteret). 
__Bolsamo, Weinstras__ (fortsattt 1800) viderefører arbeid.

Mengdelære. Samlinger av objekter (hva som helst innen matematikk. ofte tall. (mengder av tall, mendger av  mengder av tall, hvor setter man grensen for hvor generelle mengder man kan snakke om?) ) Jobber seg litt bakover? 1870. __Cantor__

__Frege (usympatisk), Russel (sympatisk), Godel (gærning).__ Hvordan lager man setninger i matematikk? LOGIKERE. 
